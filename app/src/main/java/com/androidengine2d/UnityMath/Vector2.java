package com.androidengine2d.UnityMath;
...
/*public class Vector2 {//todo
    public float X, Y;//todo
    Vector2(){//todo

    }
    Vector2(int x, int y){//todo

    }
    Vector2(float x, float y){//todo

    }
    Vector2 mult(float delta){
        return new Vector2(1,1);//todo
    }
    Vector2 plus(Vector2 delta){
        return new Vector2(1,1);//todo
    }
}*/
