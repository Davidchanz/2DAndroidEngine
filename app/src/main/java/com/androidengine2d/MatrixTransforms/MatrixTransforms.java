package com.androidengine2d.MatrixTransforms;
...
public class MatrixTransforms {
    ...
    public static Vector3 RotationX(double ct, Vector3 point, int x, int y, int z) {
        ...
        Matrix_RotationX[3][0] = x; Matrix_RotationX[3][1] = y; Matrix_RotationX[3][2] = z; Matrix_RotationX[3][3] = 1;
    ...
    public static Vector3 RotationY(double ct, Vector3 point, int x, int y, int z) {
        float[][] newDot = new float[1][4];
        newDot[0][0] = point.x;
        newDot[0][1] = point.y;
        newDot[0][2] = point.z;
        ...
        Matrix_RotationY[3][0] = x; Matrix_RotationY[3][1] = y; Matrix_RotationY[3][2] = z; Matrix_RotationY[3][3] = 1;
    ...
    public static Vector3 RotationZ(double ct, Vector3 point, int x, int y, int z) {
        float[][] newDot = new float[1][4];
        newDot[0][0] = point.x;
        newDot[0][1] = point.y;
        newDot[0][2] = point.z;
        ...
        Matrix_RotationZ[3][0] = x; Matrix_RotationZ[3][1] = y; Matrix_RotationZ[3][2] = z; Matrix_RotationZ[3][3] = 1;
